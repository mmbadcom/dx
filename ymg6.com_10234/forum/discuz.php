...
<div id="pt" class="bm cl">
  ...
  <div class="y">
    <div id="an">
      <dl class="cl">
        <dt class="bus_fl">{lang announcements}:&nbsp;</dt>
        <dd>
          <div id="anc">
            <ul id="ancl">
              $announcements
  ...
  <!--{/if}-->
  <div class="z"> <a href="./" class="nvhm" title="{lang homepage}">$_G[setting][bbname]</a><em>&raquo;</em><a href="forum.php">{$_G[setting][navs][2][navname]}</a>$navigation </div>
  <div class="z">
...
<div id="ct" class="wp cl{if $_G['setting']['forumallowside']} ct2{/if}">
  ...
  <!--[/diy]-->
  <div class="mn busdiscuz" style="width:100%;">
  ...
  <!--{hook/index_favforum_extra $forum[fid]}-->
    ...
    <div class="fl bm">
        ...
        <div id="category_-1" class="bm_c" style="{echo $collapse['category_-1']}">
          <table cellspacing="0" cellpadding="0" class="fl_tb">
            ...
            <tr class="fl_row">
              <!--{/if}-->
              <!--{/if}-->
              <td class="fl_g"{if $forumcolwidth} width=""{/if}><div class="fl_icn_g"> <a href="forum.php?mod=collection&action=view&ctid={$colletion[ctid]}" target="_blank"><img src="$_G['style'][styleimgdir]/forum{if $followcollections[$key]['lastvisit'] < $colletion['lastupdate']}_new{/if}.gif" alt="$colletion[name]" /></a> </div>
                <dl>
      ...
      <!--{/if}-->
			...
			<div class="bm bmw bus_box {if $forumcolumns} flg{/if} cl">
				<div class="bm_h cl">
					<span class="o">
        ...
        <div id="category_$cat[fid]" class="bm_c" style="{echo $collapse['category_'.$cat[fid]]}">
          <table cellspacing="0" cellpadding="0" class="fl_tb">
            <tr>
              ...
              <td class="fl_g" width=""><div class="fl_icn_g" style="width:64px;">
                  <!--{if $forum[icon]}-->
                  $forum[icon]
                  <!--{else}-->
   ...
   <!--{hook/index_bottom}-->
	...
	<div id="sd" class="sd bus_hide mt20">
		<!--{hook/index_side_top}-->
		<div class="drag">
