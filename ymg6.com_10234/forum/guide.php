	...
	<div id="ct" class="wp cl{if $_G['forum']['allowside']} ct2{/if}"{if $leftside} style="margin-left:{$_G['leftsidewidth_mwidth']}px"{/if}>
		<div class="mn">
			...
			<div id="pgt" class="bw0 pgs cl">
				$multipage
				<a onclick="showWindow('nav', this.href, 'get', 0)" href="forum.php?mod=misc&amp;action=nav"><img class="bus_guidepost" src="template/ymg6.com_10234/mobanbus_st/img/pn_post.png" alt="{lang send_posts}" / style="border-radius:5px"></a>
			</div>
			<!--{/if}-->
