...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-158269241-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-158269241-1');
</script>
</head>
...
<!--{/if}-->
	<div class="mobanbus_iner">
			...
			<div class="bus_navright <!--{if $_G['basescript'] == 'portal' && CURMODULE == 'index'}-->bus_navbgnone<!--{else}--><!--{/if}-->">
				    ...
				    <div class="bus_w100">
				      ...
				      <!--{if $_G['uid']}-->
					    ...
					    <!--{elseif !$_G[connectguest]}-->
					        <ul id="header_nav">
						        <li class="login_list"><a class="login_block"  href="member.php?mod=register" class="btn-register">$_G['setting']['reglinkname']</a></li>
					    ...
					    <ul lass="p_pop nav_pop">
							...
							<span class="bus_fl mt10"><!--{hook/global_usernav_extra1}--></span>
							<li class="tt">我的</li>
...
<!--{if $_G['basescript'] == 'portal' && CURMODULE == 'index'}--><div class="bus_bd100"><!--{else}--><div class="bus_hads"><!--{ad/headerbanner/wp a_h}--></div><div class="bus_bd98"><!--{ad/subnavbanner/a_mu}--><!--{/if}-->
